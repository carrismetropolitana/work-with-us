...
2. Visualização de Linhas — Apresentar as linhas numa interface visual simples (lista, grelha ou outro formato) utilizando pelo menos 1 componente da UI Library da TML (`<Button/>`, `<Title/>`, etc.).
...
- Utilizar pelo menos 1 componente da biblioteca de UI da TML: [@tmlmobilidade/ui](https://github.com/tmlmobilidade/core/tree/production/packages/ui)
...
- Criar uma instância MongoDB via Docker (see `compose.yml`)
